...
public class WaterBucketParticle extends SpriteBillboardParticle {
    ...
    public WaterBucketParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
